...
describe('the MainParticipantInfo component', () => {
    ...
    it('should render the AvatarIcon component when no video tracks are published', () => {
        ...
        const wrapper = shallow(<MainParticipantInfo participant={{ identity: 'mockIdentity' }}>mock children</MainParticipantInfo>);
    ...
    it('should use the switchOff status of the screen share track when it is available', () => {
        ...
        shallow(<MainParticipantInfo participant={{ identity: 'mockIdentity' }}>mock children</MainParticipantInfo>);
