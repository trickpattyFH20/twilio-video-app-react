...
describe('the UserAvatar component', () => {
    it('should display the users initials when there is a displayName property', () => {
        const wrapper = shallow(<UserAvatar user={{ displayName: 'Test User' }}/>);
