...
export default function ParticipantList() {
    ...
    return (<aside className={clsx(classes.container, {
      ...
      <div className={classes.scrollContainer}>
        ...
        return (<Participant key={participant.sid} participant={participant} isSelected={participant === selectedParticipant} onClick={() => setSelectedParticipant(participant)} hideParticipant={hideParticipant}/>);
    })}
      </div>
    </aside>);
}
