          ...
          <form onSubmit={handleSubmit}>
            <Grid container justify="space-between">
              <div className={classes.passcodeContainer}>
                ...
                <TextField id="input-passcode" onChange={(e) => setPasscode(e.target.value)} type="password" variant="outlined" size="small"/>
                <div>
                  {authError && (<Typography variant="caption" className={classes.errorMessage}>
                      <ErrorOutlineIcon />
                      {authError.message}
                    </Typography>)}
                </div>
            ...
            <Grid container justify="flex-end">
              <Button variant="contained" color="primary" type="submit" disabled={!passcode.length} className={classes.submitButton}>
                Submit
              </Button>
            </Grid>
          </form>
