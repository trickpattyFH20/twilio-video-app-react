...
export var NetworkCondition;
(function (NetworkCondition) {
    NetworkCondition[NetworkCondition["Red"] = 0] = "Red";
    NetworkCondition[NetworkCondition["Yellow"] = 1] = "Yellow";
    NetworkCondition[NetworkCondition["Green"] = 2] = "Green";
...
export default function PreflightTest() {
    ...
    return (<Grid container justify="center" alignItems="center" style={{ height: '55px', paddingBottom: '1.5em' }}>
