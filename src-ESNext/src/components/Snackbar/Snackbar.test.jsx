...
describe('the Snackbar component', () => {
    it('should render correctly with "warning" variant', () => {
        const wrapper = shallow(<Snackbar variant="warning" headline="Test Headline" message="Test Message" handleClose={() => { }} open={true}/>);
        expect(wrapper).toMatchSnapshot();
    });
    it('should render correctly with "error" variant', () => {
        const wrapper = shallow(<Snackbar variant="error" headline="Test Headline" message="Test Message" handleClose={() => { }} open={true}/>);
        expect(wrapper).toMatchSnapshot();
    });
    ...
    describe('the handleClose function', () => {
        ...
        const wrapper = shallow(<Snackbar variant="warning" headline="Test Headline" message="Test Message" handleClose={mockHandleClose} open={true}/>);
