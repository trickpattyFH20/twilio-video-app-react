...
function AudioLevelIndicator({ audioTrack, color = 'white' }) {
    ...
    return isTrackEnabled ? (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" data-test-audio-indicator>
      <defs>
