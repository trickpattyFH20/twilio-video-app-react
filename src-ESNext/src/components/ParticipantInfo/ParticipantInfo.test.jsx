...
describe('the ParticipantInfo component', () => {
    it('should render the AvatarIcon component when no video tracks are published', () => {
        ...
        const wrapper = shallow(<ParticipantInfo onClick={() => { }} isSelected={false} participant={{ identity: 'mockIdentity' }}>
        mock children
      </ParticipantInfo>);
    ...
    it('should add hideParticipant class to container component when hideParticipant prop is true', () => {
        const wrapper = shallow(<ParticipantInfo onClick={() => { }} isSelected={false} participant={{ identity: 'mockIdentity' }} hideParticipant={true}>
        mock children
      </ParticipantInfo>);
    ...
    it('should not add hideParticipant class to container component when hideParticipant prop is false', () => {
        const wrapper = shallow(<ParticipantInfo onClick={() => { }} isSelected={false} participant={{ identity: 'mockIdentity' }} hideParticipant={false}>
        mock children
      </ParticipantInfo>);
    ...
    it('should add cursorPointer class to container component when onClick prop is present', () => {
        const wrapper = shallow(<ParticipantInfo isSelected={false} participant={{ identity: 'mockIdentity' }} onClick={() => { }}>
        mock children
      </ParticipantInfo>);
    ...
    it('should not add cursorPointer class to container component when onClick prop is not present', () => {
        const wrapper = shallow(<ParticipantInfo isSelected={false} participant={{ identity: 'mockIdentity' }}>
        mock children
      </ParticipantInfo>);
    ...
    it('should render the PinIcon component when the participant is selected', () => {
        mockUsePublications.mockImplementation(() => [{ trackName: 'camera-123456' }]);
        const wrapper = shallow(<ParticipantInfo onClick={() => { }} isSelected={true} participant={{ identity: 'mockIdentity' }}>
        mock children
      </ParticipantInfo>);
    ...
    it('should add "(You)" to the participants identity when they are the localParticipant', () => {
        ...
        mockUsePublications.mockImplementation(() => [{ trackName: 'camera-123456' }]);
        const wrapper = shallow(<ParticipantInfo onClick={() => { }} isSelected={false} participant={{ identity: 'mockIdentity' }} isLocalParticipant>
        mock children
      </ParticipantInfo>);
