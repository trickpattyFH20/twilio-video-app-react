...
describe('the Publication component', () => {
    describe('when track.kind is "video"', () => {
        it('should render a VideoTrack', () => {
            ...
            const wrapper = shallow(<Publication isLocalParticipant publication={'mockPublication'} participant={'mockParticipant'}/>);
    ...
    describe('when track.kind is "audio"', () => {
        ...
        it('should render null when videoOnly is true', () => {
            ...
            const wrapper = shallow(<Publication isLocalParticipant publication={'mockPublication'} participant={'mockParticipant'} videoOnly={true}/>);
            expect(useTrack).toHaveBeenCalledWith('mockPublication');
